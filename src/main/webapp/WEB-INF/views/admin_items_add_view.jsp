...
<!-- 네비바 -->
	...
	<div id="content" class="d-flex flex-row bd-highlight mb-3">
		...
		<div class="main-content container col-md-9">
			...
			<form method="post" action="admin_items_add_modify"
				name="admin_items_add_modify" id="admin_items_add_modify">
				<table class="table">
					<tr>
						<td>상품명 <input type="hidden" id="add_idx" name="add_idx" value="${ dto.add_idx }"></td>
						<td><input type="text" id="add_title" name="add_title"
							value="${ dto.add_title }"></td>
					</tr>
					<tr>
						<td>판매가격</td>
						<td><input type="text" id="add_price" name="add_price"
							value="${ dto.add_price }"></td>
					</tr>
					<tr>
						<td>판매수량</td>
						<td><input type="text" id="add_count" name="add_count"
							value="${ dto.add_count }"></td>
					</tr>
					<tr>
						<td>제품 설명</td>
						<td><textarea id="add_content" name="add_content" rows="10"
								cols="30">${ dto.add_content }</textarea></td>
					</tr>
					<tr>
					<td></td>
						<td style="text-align: center;"><input class="btn btn-primary" type="submit" value="등록"><span class="spanBlank"></span></td>
					</tr>
				</table>
			</form>
