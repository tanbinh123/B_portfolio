	...
	<div id="content" class="d-flex flex-row bd-highlight mb-3">
		...
		<table style="" class=" table table-bordered">
			<tr>
				...
				<td style="text-align: center;">주문자</td>
				<td>${ dto.cancel_id }</td>
			</tr>
			
			<tr>

				<td style="text-align: center;">주문상품명</td>
				<td>${ dto.cancel_title }</td>
			</tr>
			<tr class="" style="">
				<td class="" style="text-align: center;">사유</td>
				<td>${ dto.cancel_status }</td>
			</tr>
			<tr>

				<td style="text-align: center;">내용</td>
				<td>${ dto.cancel_content }</td>
			</tr>
		</table>
